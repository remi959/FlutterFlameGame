...
- [x] A hosted working web game on github pages, provide us the url
...
- [x] The game uses Flame effects to modify the properties/appearance of a component ([docs](https://docs.flame-engine.org/1.6.0/flame/effects.html))
- [x] The game has some form of input to change the game state
- [x] The game has background music and some audio effects ([docs](https://docs.flame-engine.org/1.6.0/bridge_packages/flame_audio/audio.html#audio))
- [x] The game uses some Flame particle effects ([docs](https://docs.flame-engine.org/1.6.0/flame/rendering/particles.html#particles))
